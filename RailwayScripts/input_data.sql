...
/
--Route
insert into route(fk_train_id,fk_departure_station_id,fk_arrival_station_id,arrival_time,travel_time) values(1,1,2,to_timestamp('12:00','HH24:MI'),interval '5:50' hour to minute);
insert into route(fk_train_id,fk_departure_station_id,fk_arrival_station_id,arrival_time,travel_time) values(1,2,6,to_timestamp('18:00','HH24:MI'),interval '3:32' hour to minute);
