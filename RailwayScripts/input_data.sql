...
/
--train
insert into train(fk_rolling_stock_id,fk_dispatch_station_id,fk_arrival_station_id) values(1,1,6);
insert into train(fk_rolling_stock_id,fk_dispatch_station_id,fk_arrival_station_id) values(2,1,4);
insert into train(fk_rolling_stock_id,fk_dispatch_station_id,fk_arrival_station_id) values(3,1,4);
insert into train(fk_rolling_stock_id,fk_dispatch_station_id,fk_arrival_station_id) values(4,2,3);
insert into train(fk_rolling_stock_id,fk_dispatch_station_id,fk_arrival_station_id) values(5,2,1);
/
--Route
insert into route(fk_train_id,fk_dispatch_station_id,fk_arrival_station_id,arrival_time,travel_time) values(1,1,2,to_timestamp('12:00','HH24:MI'),interval '5:50' hour to minute);
insert into route(fk_train_id,fk_dispatch_station_id,fk_arrival_station_id,arrival_time,travel_time) values(1,2,6,to_timestamp('18:00','HH24:MI'),interval '3:32' hour to minute);
--insert into route(fk_train_id,fk_dispatch_station_id,fk_arrival_station_id) values(2,2,3);
--insert into route(fk_train_id,fk_dispatch_station_id,fk_arrival_station_id) values(3,2,1);
--insert into route(fk_train_id,fk_dispatch_station_id,fk_arrival_station_id) values(1,2,3);
/
--train_schedule
